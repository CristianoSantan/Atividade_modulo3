...
namespace Bookstore.Controllers
{
    public class AutorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_autor,Nome,Sobrenome")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_autor,Nome,Sobrenome")] Autor autor)
        {
